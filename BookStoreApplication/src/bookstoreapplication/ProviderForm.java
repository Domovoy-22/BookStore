...
public class ProviderForm extends javax.swing.JFrame {
    ...
    public ProviderForm(DatabaseConnection databaseConnection) {

        this.databaseConnection = databaseConnection;
        valid = new Validation();
        initComponents();
        jTableProvider.setDefaultEditor(Object.class, null);
    ...
    private void Update_table() {
        ...
        try {
             resultSet = databaseConnection.select("id_provider as 'id', name_provider as 'ФИО', number_phone as 'Номер телефона'", "provider", null);
            jTableProvider.setModel(DbUtils.resultSetToTableModel(resultSet));
            jTableProvider.removeColumn(jTableProvider.getColumnModel().getColumn(0));
            TableRowSorter<TableModel> sorter = new TableRowSorter<TableModel>(jTableProvider.getModel());
            jTableProvider.setRowSorter(sorter);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jTableProvider.setFont(new java.awt.Font("Comic Sans MS", 3, 12)); // NOI18N
        ...
        jTableProvider.setToolTipText("Выберите должность для редактирования");
        ...
        nameField.setToolTipText("Ввод букв русского алфавита");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(phoneField, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (error.getText().isEmpty()) {
            if (nameField.getText().isEmpty() || phoneField.getText().isEmpty()) {
                ...
                try {
                     databaseConnection.insert("provider (name_provider, number_phone)",
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            databaseConnection.delete("provider", "id_provider = " + idLabel.getText());
            idLabel.setText("");
            nameField.setText("");
            phoneField.setText("");
        } catch (Exception e) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            databaseConnection.update("provider", "name_provider = '" + valuesurName + "', number_phone = '" + valuePhone + "'", "id_provider = " + valueId);
    ...
    private void jTableProviderMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableProviderMouseClicked
        ...
        try {
           int row = jTableProvider.getSelectedRow();
            String tableClick = (jTableProvider.getModel().getValueAt(row, 0).toString());
            resultSet = databaseConnection.select("*", "provider", "id_provider = " + tableClick);
            if (resultSet.next()) {
                String add1 = resultSet.getString("id_provider");
                idLabel.setText(add1);
                idLabel.setVisible(false);
                String add2 = resultSet.getString("name_provider");
                nameField.setText(add2);
                String add3 = resultSet.getString("number_phone");
                phoneField.setText(add3);
            }
        } catch (Exception e) {
            System.out.println(e.toString());
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ProviderForm(new DatabaseConnection()).setVisible(true);
            }
        });
    }
